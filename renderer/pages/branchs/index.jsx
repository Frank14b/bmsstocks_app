...
function IndexBranchsComponent() {
        ...
        <React.Fragment>
            ...
            <div className={`p-2 mt-5 pt-5 ${styles.mainSection}`}>
                ...
                <div className={`border rounded shadow-sm bg-light col-md-11 mx-auto mt-3 position-relative py-1 px-2`}>
                    <span>
                        <h5 className={`${styles.bold700} ${styles.textPrimary} mx-3`}><FaBuilding></FaBuilding> Branchs</h5>
                    </span>
...
export default IndexBranchsComponent;
