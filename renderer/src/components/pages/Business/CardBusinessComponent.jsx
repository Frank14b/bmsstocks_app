...
function CardBusinessComponent({ data }) {
    ...
    const startBusiness = (data) => {
        Utils.saveLocalStorage("currentbusiness", data)
        myContext.setCurrentBusiness(data)
...
export default CardBusinessComponent;
