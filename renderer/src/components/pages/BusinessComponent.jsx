...
import CardBusinessComponent from './Business/CardBusinessComponent';
...
function BusinessComponent() {
  ...
  const getUserBusiness = (e) => {
    ...
    if(!Utils.getLocalStorage("userData")) {
      return
    }
                ...
                (userBusiness && userBusiness.length > 0) ? (
                  userBusiness.map((data, index) => (
                    <div className='col-md-3' key={index}>
                      <CardBusinessComponent data={data}></CardBusinessComponent>
                    </div>
                  ))
                ) : (
                  <></>
